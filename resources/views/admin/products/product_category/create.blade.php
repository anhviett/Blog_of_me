...
@section('title'){{'Create Product Categories'}}@endsection
@section('content')
    {{--wrapper--}}
<div class="wrapper">
            ...
            <div class="row">
                <div class="col-md-8 mx-auto">
                    <div class="card card-primary">
                        ...
                        <form action="{{route('product_category.store')}}" method="POST" id="product_category">
                            @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="inputParentCategories" id="inputParentCategories" class="form-control">
