                    ...
                    <div class="col-sm-5">
                        ...
                        <div id="similar-product" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="{{$img['id'] == 1 ? 'active' : ''}}">
                                    <a href=""><img style="width: 100px; height: 100px" src="{{ asset('uploads/' . $img->path) }}" alt="">
                ...
                <div class="category-tab shop-details-tab"><!--category-tab-->
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="companyprofile" >
                            @foreach($relate as $key => $involve)
                            <div class="col-sm-3">
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="{{asset('/uploads/').'/'.$involve->avatar}}" alt="" />
                                            <h2>${{number_format($involve->price)}}</h2>
                                            <p>{{$involve->name}}</p>
                                            <button type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</button>
                                        </div>
                                    </div>
                        ...
                        @include('livewire.customer.customer-review-component')
                                    ...
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center" style="height: auto">
                                                <img style="height: auto" src="{{asset('site/assets/images/home/recommend1.jpg')}}" alt="" />
                                                <h2>$56</h2>
                                                <p>Easy Polo Black Edition</p>
                                                <button type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</button>
                                            </div>
